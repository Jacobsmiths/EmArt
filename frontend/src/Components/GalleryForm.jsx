    ...
    return (
      ...
      >
        <div className="bg-white rounded-2xl w-full max-w-3xl">
          ...
          <Form
            onSubmit={(data) => {
              if (!data.painting || isNaN(Number(data.painting))) {
            ...
            <label>
              ...
              <Select
                ...
                options={[
                  ...
                  ...paintings
                    .filter((p) => !galleryPaintingIDs.has(p.id))
                    .map((p) => ({
                      value: p.id,
                      label: p.name,
                    })),
                  ...
                  <td className="p-3 text-center">
                    <span
                      className={`inline-block w-3 h-3  ${
                        sold ? "bg-green-500" : "bg-gray-300"
                      }`}
                    ></span>
                  </td>
                  <td className="p-3 text-center" style={{ width: "200px" }}>
                    <Button
                      type="button"
                      onClick={() => removePainting(painting.id)}
